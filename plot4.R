...
#topleft plot
with(working_data, plot(Full_date, Global_active_power, type = "l",
                        ylab = "Global Active Power"))

#topright plot
with(working_data, plot(Full_date, Voltage, type = "l",
...
#bottomright plot
with(working_data, plot(Full_date, Global_reactive_power, type = "l",
